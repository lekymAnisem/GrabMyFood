...
const seedData = [
  {
    ...
    thumbnailUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDNcbMQEgMB7QrOrgdjPvrj-25lZogOuS2AjLH3C4GaaSTnfilU18jB71woaD3mENoDAjqMmv3QdGZCVqAFSaJSyl68oON4VDJ_RhOsA-Jg4NrwCgnWdP8S3cpn5rmYu5y-v53h-hm5abdadPcPPAwhTnO_ejiJnVxu4zmtHUEOnKft_rnEIo6_s1c8PMna5tmlXRuBMmSgUHBkeyZoFr90lYuhZN2sS2j5uTN8PkhZV__45AoEsBLqDUDwShHfaFkHJypIo6dSx_Q',
    featured: true,
    isAvailable: true,
    address: '124 Via Roma, Downtown',
    tagline: 'Premium Italian',
    reviews: [
      { id: 'rev1', userName: 'Marco V.', rating: 5, comment: 'The truffle risotto is absolutely divine! A true taste of Rome.', createdAt: '2025-12-15T18:30:00Z' },
      { id: 'rev2', userName: 'Sophie L.', rating: 4, comment: 'Beautiful ambiance and even better pasta. Will definitely order again.', createdAt: '2025-11-20T19:00:00Z' },
    ],
  },
  {
    id: 'r2',
    ...
    tagline: 'Italian • Pizza • Gourmet',
    reviews: [
      { id: 'rev3', userName: 'Alex P.', rating: 5, comment: 'Best pizza in town! The sourdough crust is incredible.', createdAt: '2025-12-10T20:00:00Z' },
    ],
  },
  {
    id: 'r3',
    ...
    thumbnailUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCqa6keXYfgTsyNr1Yu9Dcb5chbzYXzRpbF2I8lHNPqAbWf5PswsHzjtX6C29bIVWCkOEqL2_krKv74oOhvnoiG3JGgw_NUX9ka7QnUVghxJ1QTVaM8Y8c9MbKz4Pt81Z9T3j-mbfc97ZX7S2DifY2fEafqqTsv6u9zYB5hPs6DVvwLQl1_Sxp7q9S6X9SdwJIxoeLLPrIl7kLX34wbbu64wHpCXqSRGPwApIDDMygp0fQOlcLpN_nfzBuYGqkUtbttE0RW7wyyhOE',
    featured: true,
    isAvailable: true,
    address: '789 Patty Lane, West Side',
    tagline: 'American • Burgers • Grill',
    reviews: [
      { id: 'rev4', userName: 'Jordan T.', rating: 5, comment: 'The double smash burger is life-changing!', createdAt: '2025-12-05T13:00:00Z' },
      { id: 'rev5', userName: 'Casey R.', rating: 4, comment: 'Great burgers, love the truffle fries.', createdAt: '2025-11-28T18:45:00Z' },
    ],
  },
  {
    id: 'r4',
    ...
    thumbnailUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCKb3YMbOBpnjEnGMVyH82jpsl1V4kDl6PkoE_Kl0Ne5aMHxBwTMCuHsP_x6FL6F0-lDVLXs0L7iHTgpXUJbfZGOLVS_sp8924t_dfIQ3h5LCvcaKd20Y0g6sajLA4u3PasLFs3TQj3QfuBz1VrTqCY-vSVBUQigT3KxH538kItYFMxIq1cHrgKm0qL1dCimhE2dmtzrCg_xUDM6WfWhfNxDx7801pZ0qdXfm1YlSH0jIrZigGuvQKTRy4zDTlk3zzINXaLP0mFuo4',
    featured: true,
    isAvailable: true,
    address: '321 Ocean Drive, East Side',
    tagline: 'Japanese • Sushi • Healthy',
    reviews: [
      { id: 'rev6', userName: 'Mia K.', rating: 5, comment: 'The freshest sashimi I have had outside of Japan!', createdAt: '2025-12-18T20:30:00Z' },
    ],
  },
  {
    id: 'r5',
    ...
    thumbnailUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAdaedvirvgRlnghe-sJyiNpPDh1fS7NjFndyN1Jpcan8dLmSMTTORb_l7dPbxVNL_37qhuA1B9jSbKc9BBcjW0LeSrYrWAc9M0EJuvpuJz922CyQfVE12apB1i75zP7sBGRL-2ijI_5eTU95OGhlfUQmqwveynSTSHOxHX-0Bo_mzMIRrmAxgMWbsNvV972ZNsW5Cb5beIx-xOeyYB5xR39AO2IJhp8hgdh1WkRPhznUL5bLVk09C_WvRgRfmNDk0vCLV_x3boUBE',
    featured: true,
    isAvailable: true,
    address: '555 Salsa Boulevard, South Side',
    tagline: 'Mexican • Street Food • Spicy',
    reviews: [
      { id: 'rev7', userName: 'Carlos M.', rating: 5, comment: 'Best al pastor tacos in the city!', createdAt: '2025-12-12T14:15:00Z' },
      { id: 'rev8', userName: 'Emma W.', rating: 4, comment: 'Love the spicy salsa verde!', createdAt: '2025-11-30T19:30:00Z' },
    ],
  },
  {
    id: 'r6',
    ...
    thumbnailUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDtq5vJZ0rh9TvVdaSHQLwjyAZnKSHlw4CRFSwjRkPG-9dKCg8znbYS-3JcEAwhsfVvh7UKro2uf773i-wyOz5Qo_Q-6Sjk3GTLwILM5G5-jgLzQix7wxbqVOIXQPIrWr0gUYml2MitwM_g2_aoEpLl_g86wNdkxYswaozZZJeJAuV-3M8C15ajcJUCP5mGjxU588GL0SIRJG3ZO10DV1JI5nzOhcmZhWiYgIa-QwKa8aSfnz8lul4Cw9MwL0WHSU8oYwQBNnVN54U',
    featured: false,
    isAvailable: true,
    address: '888 Rue de la Cuisine, Downtown',
    tagline: 'French • Bistro • Premium',
    reviews: [
      { id: 'rev9', userName: 'Pierre D.', rating: 5, comment: 'Exquisite French cuisine. The coq au vin is remarkable.', createdAt: '2025-12-01T21:00:00Z' },
    ],
  },
];
...
export function getFeaturedRestaurants() {
  return Array.from(restaurants.values()).filter((r) => r.featured);
}
